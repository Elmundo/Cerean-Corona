...
local CiderRunMode = {};CiderRunMode.runmode = 'DEBUG';CiderRunMode.assertImage = true;CiderRunMode.userdir = "C:/Users/admin/AppData/Roaming/.luaglider28/dev";local SOCKET_PORT=48052;local GLIDER_MAIN_FOLDER= "C:/Development/Cerean-Corona";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
